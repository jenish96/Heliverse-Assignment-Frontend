...
function UpdateUser(props) {
    ...
    const handleSubmit = async () => {
        let result = await fetch(`https://heliverse-assignment-backend-bice.vercel.app/api/users/${user.id}`, {
            method: 'PUT',
            headers: {
                            ...
                            <div class="col-span-2 flex ">
                                ...
                                <div className="flex ml-5 mt-2 mb-5 p-2 ps-4 border border-gray-200 rounded dark:border-gray-700">
                                    <div class="flex items-center me-4">
                                        <input id="available" value="true" checked={user?.available === true} type="radio" onChange={(e) => setUserData({ ...user, available: e.target.value })} name="inline-radio-group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label for="available" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Available</label>
                                    </div>
                                    <div class="flex items-center me-4">
                                        <input id="available" value="false" checked={user?.available === false} type="radio" onChange={(e) => setUserData({ ...user, available: e.target.value })} name="inline-radio-group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
